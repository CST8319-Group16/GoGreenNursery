...
<%
    ...
    headerTitle = headerTitle == null ? "Go Green Platform" : headerTitle;
%>
...
<nav class="bg-teal-800 group">
    <div class="mx-auto max-w-6xl px-6 flex h-20 items-center justify-between">
        ...
        <div class="flex space-x-1">
            ...
            <%--Cart--%>
            <form action="item" method="get" class="m-0 <%= u != null ? "" : "hidden" %>">
            ...
            <%--My Order--%>
            <form action="userOrder" method="get" class="m-0 <%= u != null ? "" : "hidden" %>">
